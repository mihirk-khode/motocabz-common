...
const (
	...
	Demo_Create_FullMethodName   = "/demo.Demo/Create"
)
...
func (c *demoClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedDemoServer) Create(context.Context, *CreateRequest) (*CreateResponse, error) {
